...
<div class="flex justify-between items-center">
 <h6 class=" mt-2text-12xl  font font-serif cursor-pointer">
  ...
  <li class="mx-4 my-6 md:my-0 mt-2"><a href="#" class="text-sm hover:text-cyan-500 duration-500"> Abonée</a></li>
   ...
   <a href="inscription.jsp" class="">Inscription</a>
   </button>
...
<div class="row">
    ...
    <div class="col s12 m6">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          <span class="card-title">Gestion des inscription des abonnee</span>
          <p>Inscription etudiant interb exten et enseignant</p>
        </div>
    ...
    <div class="col s12 m6">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          <span class="card-title">Gestion des abonnee</span>
<p>Supprimer modifier un abonnee</p>
        </div>
        <div class="card-action">
          <a href="listAbonnee.jsp">list Abonnee</a>
   ...
   <div class="col s12 m6 l3">  <div class="row">
    <div class="col s12 m6">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          <span class="card-title">Penalisation abonnee</span>
          <p>penalisation etudiant intern extern enseignat</p>
        </div>
        <div class="card-action">
          <a href="listpenalisation.jsp">Penalisation</a>
